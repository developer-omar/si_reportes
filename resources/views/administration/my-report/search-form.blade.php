<form action="{{ route('administration.my-report.index') }}" method="GET">
    <div class="row">
    ...
    <div class="row">
        <div class="p-2 p-lg-2 col-12 col-lg-4">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-search"></i>
                Buscar
            </button>
            <a class="btn btn-primary" href="{{ route('administration.my-report.index') }}" role="button">
